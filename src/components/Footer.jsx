...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-20 relative overflow-hidden text-center">
      {/* Background Shape */}
              ...
              {["About Us", "Courses", "Scholarship", "Contact"].map((item, index) => (
                <li key={index}>
                  <Link
                    ...
                    className="hover:text-orange-400 transition duration-300 flex justify-center items-center"
                  >
